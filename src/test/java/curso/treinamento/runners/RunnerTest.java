...
@CucumberOptions(
	...
	//strict = true, // Falha se não tiver implementado um ou mais passos
	tags = { "@Sprint2"}  // Declaração das tags "~@ParaNegarUmaTag",  se vc colocar entre chaves ele aceita varias tags
	) 
